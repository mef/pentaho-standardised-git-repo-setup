...
# ========== ORGANISATION SPECIFIC CONFIGURATION PROPERTIES =========== #

## ~~~~~~~~~~~~~~~~~ AMEND FOR YOUR ORGANISATION ~~~~~~~~~~~~~~~~~~~~~##
...
export PSGRS_GIT_CONFIG_REPO_ACCEPTED_FILE_EXTENSIONS_REGEX="gitignore$|md$|properties$|sh$|spec$|spoonrc$|json$|xml$|txt$|csv$"
